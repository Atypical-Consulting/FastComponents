...
## HtmxResponseHeaders\.TriggerWithDetails\(object\) Method

Allows you to trigger client\-side events with details

```csharp
public FastComponents.Http.HtmxResponseHeaders TriggerWithDetails(object eventDetails);
```
#### Parameters

<a name='FastComponents.Http.HtmxResponseHeaders.TriggerWithDetails(object).eventDetails'></a>
