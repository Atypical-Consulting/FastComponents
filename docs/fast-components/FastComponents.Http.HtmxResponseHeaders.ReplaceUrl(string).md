...
## HtmxResponseHeaders\.ReplaceUrl\(string\) Method

Replaces the current URL in the location bar

```csharp
public FastComponents.Http.HtmxResponseHeaders ReplaceUrl(string url);
```
#### Parameters

<a name='FastComponents.Http.HtmxResponseHeaders.ReplaceUrl(string).url'></a>
