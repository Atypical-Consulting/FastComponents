...
public interface IHxCssClasses
{
    ...
    /// </summary>
    public string? HxCssAdded { get; set; }
    ...
    /// </summary>
    public string? HxCssIndicator { get; set; }
    ...
    /// </summary>
    public string? HxCssRequest { get; set; }
    ...
    /// </summary>
    public string? HxCssSettling { get; set; }
    ...
    /// </summary>
    public string? HxCssSwapping { get; set; }
}
